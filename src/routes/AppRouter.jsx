    ...
    // =====================================================
    {
        ...
        children: [
            ...
            },
            {
                ...
                element: (
                    <UserPageWrapper requiredRoles={["TEACHER"]}>
                        <ComingSoon title="Attendance Management"
                                    description="Manage student attendance and daily records."/>
                    </UserPageWrapper>
                ),
            },
            {
            ...
            },
            {
                ...
                element: (
                    <UserPageWrapper requiredRoles={["TEACHER"]}>
                        <ComingSoon title="Teacher Journal"
                                    description="Keep track of daily activities and observations."/>
                    </UserPageWrapper>
                ),
            },
            {
                ...
                element: (
                    <UserPageWrapper requiredRoles={["TEACHER"]}>
                        <ComingSoon title="Teacher Messages"
    ...
    // =====================================================
    {
        ...
        children: [
            ...
            },
            {
                ...
                element: (
                    <UserPageWrapper requiredRoles={["PARENT"]}>
                        <ComingSoon title="Child Profile"
                                    description="View your child's profile and development progress."/>
                    </UserPageWrapper>
                ),
            },
            {
                ...
                element: (
                    <UserPageWrapper requiredRoles={["PARENT"]}>
                        <ComingSoon title="Parent Calendar"
                                    description="View school calendar and your child's schedule."/>
                    </UserPageWrapper>
                ),
            },
            {
                ...
                element: (
                    <UserPageWrapper requiredRoles={["PARENT"]}>
                        <ComingSoon title="Meals Schedule"
                                    description="View weekly meal plans and dietary information."/>
                    </UserPageWrapper>
                ),
            },
            {
            ...
            },
            {
                ...
                element: (
                    <UserPageWrapper requiredRoles={["PARENT"]}>
                        <ComingSoon title="Parent Feedback"
                                    description="Provide feedback about your child's experience."/>
                    </UserPageWrapper>
                ),
            },
            {
    ...
    // =====================================================
    {
        ...
        children: [
            ...
            },
            {
                ...
                element: (
                    <UserPageWrapper requiredRoles={["EDUCATION"]}>
                        <ComingSoon title="Educational Resources"

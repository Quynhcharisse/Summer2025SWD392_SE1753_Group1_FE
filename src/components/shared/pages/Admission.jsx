...
import { ProcessStepCard, ProgramCard, InfoListCard } from "../molecules";
    ...
    >      <div className="space-y-8 sm:space-y-12">        {/* Programs Section */}
        ...
        <section className="bg-gradient-primary text-white p-6 sm:p-8 rounded-lg sm:rounded-xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-md mx-auto">
            <Button variant="secondary" size="md" className="flex items-center justify-center gap-2 text-sm sm:text-base">

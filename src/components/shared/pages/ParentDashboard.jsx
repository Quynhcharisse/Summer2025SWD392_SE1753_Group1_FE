  ...
  useEffect(() => {
    const checkAuthAndLoadData = async () => {
      try {
        ...
        // Load applications
        const userApplications = await enrollmentService.getUserEnrollmentApplications();
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-800">Đơn đăng ký gần đây</h3>
                <Button 
                  variant="ghost" 
                  size="sm"
                  onClick={() => navigate('/enrollment/my-applications')}
              ...
              {applications.length > 0 ? (
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-500">
                            Ngày nộp: {new Date(application.applicationDate).toLocaleDateString('vi-VN')}
                          </p>
                        </div>
                        <Button 
                          variant="outline" 
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 mb-4">Bạn chưa có đơn đăng ký nào</p>
            ...
            {/* Upcoming Events */}
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Sự kiện sắp tới</h3>
              {upcomingEvents.length > 0 ? (
                ...
                <p className="text-gray-500 text-center py-4">Không có sự kiện nào sắp tới</p>
              )}
            </div>
          </div>

...
import { getTransactionList, exportTransactions } from '@api/services/admissionService';
                    ...
                    <Table>
                        <TableHead>
                            <TableRow sx={{ 
                                ...
                                <TableCell align="center" sx={{ fontWeight: 600, color: 'white' }}>Trace Number</TableCell>
                                <TableCell align="center" sx={{ fontWeight: 600, color: 'white' }}>Invoice Number</TableCell>
                                ...
                                <TableCell align="center" sx={{ fontWeight: 600, color: 'white' }}>Created Date</TableCell>
                                <TableCell align="center" sx={{ fontWeight: 600, color: 'white' }}>Payment Content</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>

    ...
    <Dialog fullScreen open={isPopUpOpen} onClose={handleClosePopUp}>
      ...
      <Box p={4}>
        ...
        <Stack spacing={3}>
            ...
            <TextField
              ...
              value={
                selectedTerm.startDate
                  ? dayjs(selectedTerm.startDate).format("YYYY-MM-DD")
                  : ""
              }
              required
              fullWidth
            ...
            <TextField
              ...
              value={
                selectedTerm.endDate
                  ? dayjs(selectedTerm.endDate).format("YYYY-MM-DD")
                  : ""
              }
              required
              fullWidth
          ...
          <Typography fontWeight="bold" sx={{ mt: 1, mb: 0, color: "#07663a" }}>
            Fees
          </Typography>
      ...
      <DialogActions
        sx={{ justifyContent: "flex-end", px: 4, py: 3, gap: "1rem" }}
      >
        <Button
...
function RenderFormPopUp({ isPopUpOpen, handleClosePopUp, GetTerm }) {
  ...
  const handleCreate = async (formData) => {
    ...
    if (response.success) {
      ...
      enqueueSnackbar(response.message || "Failed to create term", {
        variant: "error",
      });
    }
  };
    ...
    >
      ...
      <DialogContent>
        <Box sx={{ mt: 2, display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          />
          <Typography fontWeight="bold" sx={{ mt: 1, mb: 0 }}>
            Fees
          </Typography>
          <TextField
            label="Reservation Fee"
